...
insert into producto (nombre ,precio,categoria,cantbod) values('product 1',2500,2,1500);
insert into producto (nombre ,precio,categoria,cantbod) values('product 2',2550,2,1500);
insert into producto (nombre ,precio,categoria,cantbod) values('product 3',2800,2,1500);
